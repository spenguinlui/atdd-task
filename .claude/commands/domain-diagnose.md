...
```
1. 執行: python3 .claude/scripts/domain-health.py {atdd-hub-path} --format json --output /tmp/domain-health-latest.json
2. Read: /tmp/domain-health-latest.json
...
```
1. Read: domains/{project}/ul.md → 擷取所有 UL 術語
