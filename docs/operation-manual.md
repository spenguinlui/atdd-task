...
本手冊說明如何使用 ATDD task 的 Command-Driven 工作流程進行專案任務開發。
...
<div class="flow-svg" markdown="0" style="margin:20px 0;">
<svg viewBox="0 0 640 392" role="img" aria-labelledby="feq-t" style="width:100%;height:auto;max-width:560px;display:block;font-family:Inter,-apple-system,'Segoe UI',sans-serif;">
  <title id="feq-t">Feature → Epic 上升流程</title>
  <defs><marker id="feq-ah" markerWidth="10" markerHeight="8" refX="7" refY="3" orient="auto" markerUnits="userSpaceOnUse"><path d="M0,0 L7,3 L0,6 Z" fill="#B6C0CC"/></marker></defs>
  <rect x="1" y="1" width="638" height="390" rx="16" fill="#F7F9FB" stroke="#EEF1F5"/>

  <rect x="170" y="18" width="300" height="34" rx="17" fill="#EFF6FF" stroke="#BFDBFE"/>
  <text x="320" y="40" text-anchor="middle" font-family="'JetBrains Mono',monospace" font-size="12.5" fill="#2563EB">/feature sf_project, 實作折讓功能</text>
  <line x1="320" y1="56" x2="320" y2="81" stroke="#B6C0CC" stroke-width="2" marker-end="url(#feq-ah)"/>

  <rect x="230" y="86" width="180" height="40" rx="10" fill="#FFFFFF" stroke="#E5E9EF"/>
  <text x="320" y="111" text-anchor="middle" font-size="14" fill="#1F2D3D">信心度評估（澄清）</text>
  <line x1="320" y1="126" x2="320" y2="159" stroke="#B6C0CC" stroke-width="2" marker-end="url(#feq-ah)"/>
  <rect x="332" y="133" width="104" height="20" rx="10" fill="#FFFFFF" stroke="#E5E9EF"/>
  <text x="384" y="147" text-anchor="middle" font-size="11.5" fill="#7B8794">信心度 ≥ 95%</text>

  <rect x="215" y="163" width="210" height="50" rx="10" fill="#F7F9FB" stroke="#E5E9EF"/>
  <text x="320" y="185" text-anchor="middle" font-size="14" font-weight="600" fill="#1F2D3D">範圍評估</text>
  <text x="320" y="203" text-anchor="middle" font-size="11.5" fill="#7B8794">判斷是否上升 Epic</text>

  <path d="M320 213 V237 M180 237 H460" stroke="#B6C0CC" stroke-width="2" fill="none"/>
  <line x1="180" y1="237" x2="180" y2="258" stroke="#B6C0CC" stroke-width="2" marker-end="url(#feq-ah)"/>
  <line x1="460" y1="237" x2="460" y2="258" stroke="#B6C0CC" stroke-width="2" marker-end="url(#feq-ah)"/>

  <rect x="110" y="262" width="140" height="40" rx="10" fill="#FFFFFF" stroke="#E5E9EF"/>
  <text x="180" y="287" text-anchor="middle" font-size="13.5" fill="#54606E">維持 Feature</text>
  <line x1="180" y1="302" x2="180" y2="331" stroke="#B6C0CC" stroke-width="2" marker-end="url(#feq-ah)"/>
  <rect x="130" y="335" width="100" height="38" rx="10" fill="#F8FAFC" stroke="#E5E9EF"/>
  <text x="180" y="359" text-anchor="middle" font-size="13.5" fill="#54606E">繼續</text>

  <rect x="355" y="262" width="210" height="50" rx="10" fill="#FFFBEB" stroke="#FDE68A"/>
  <text x="460" y="284" text-anchor="middle" font-size="13.5" font-weight="600" fill="#B45309">建議上升 Epic</text>
  <text x="460" y="301" text-anchor="middle" font-size="11.5" fill="#B7791F">（詢問用戶）</text>
  <line x1="460" y1="312" x2="460" y2="341" stroke="#B6C0CC" stroke-width="2" marker-end="url(#feq-ah)"/>
  <rect x="380" y="345" width="160" height="34" rx="17" fill="#EFF6FF" stroke="#BFDBFE"/>
  <text x="460" y="367" text-anchor="middle" font-family="'JetBrains Mono',monospace" font-size="12.5" fill="#2563EB">/epic ...</text>
</svg>
</div>
...
<div class="flow-svg" markdown="0" style="margin:20px 0;">
<svg viewBox="0 0 640 322" role="img" aria-labelledby="stp-t" style="width:100%;height:auto;max-width:600px;display:block;font-family:Inter,-apple-system,'Segoe UI',sans-serif;">
  <title id="stp-t">/status 輸出範例</title>
  <rect x="20" y="10" width="600" height="302" rx="12" fill="#FFFFFF" stroke="#E5E9EF"/>
  <path d="M20 22 a12 12 0 0 1 12 -12 H608 a12 12 0 0 1 12 12 V54 H20 Z" fill="#F7F9FB"/>
  <line x1="20" y1="54" x2="620" y2="54" stroke="#E5E9EF" stroke-width="1"/>
  <text x="44" y="37" font-size="14" font-weight="600" fill="#1F2D3D">📊 sf_project 任務狀態</text>

  <text x="44" y="88" font-size="14" font-weight="600" fill="#1F2D3D">🎯 Epic：發票折讓體系</text>
  <text x="64" y="118" font-size="13" fill="#54606E">進度 13/17</text>
  <rect x="170" y="109" width="150" height="9" rx="4.5" fill="#EEF1F5"/>
  <rect x="170" y="109" width="114" height="9" rx="4.5" fill="#10B981"/>
  <text x="330" y="118" font-size="12.5" fill="#7B8794">76%</text>
  <text x="378" y="118" font-size="12.5" fill="#9AA5B1">剩餘 4 tasks</text>

  <text x="64" y="152" font-size="13.5" fill="#54606E">✅ Phase 1：調查確認</text>
  <text x="576" y="152" text-anchor="end" font-family="'JetBrains Mono',monospace" font-size="12.5" fill="#7B8794">5/5</text>
  <text x="64" y="180" font-size="13.5" fill="#54606E">✅ Phase 2：技術債清理</text>
  <text x="576" y="180" text-anchor="end" font-family="'JetBrains Mono',monospace" font-size="12.5" fill="#7B8794">3/3</text>
  <text x="64" y="208" font-size="13.5" font-weight="600" fill="#1F2D3D">🔄 Phase 4：折讓體系建立</text>
  <text x="576" y="208" text-anchor="end" font-family="'JetBrains Mono',monospace" font-size="12.5" fill="#F59E0B">1/5</text>

  <g font-family="'JetBrains Mono',monospace" font-size="12.5" fill="#54606E">
    <text x="92" y="236">├─ ✅ T4.1 建立資料表</text>
    <text x="92" y="262">├─ ⏳ T4.2 實作 AR Allowance <tspan fill="#9AA5B1">(可開始)</tspan></text>
    <text x="92" y="288">└─ 🔒 T4.4 整合 EcPay <tspan fill="#9AA5B1">(等待 T4.2, T4.3)</tspan></text>
  </g>
</svg>
</div>
...
> 以下為 6 個主工作流程 Agent。另有一個輔助 Agent 不在此流程內：**curator**（Domain 知識庫策展）。
...
<div class="flow-svg" markdown="0" style="margin:20px 0;">
<svg viewBox="0 0 640 168" role="img" aria-labelledby="tlp-t" style="width:100%;height:auto;max-width:600px;display:block;font-family:Inter,-apple-system,'Segoe UI',sans-serif;">
  <title id="tlp-t">多任務選擇清單</title>
  <rect x="20" y="10" width="600" height="148" rx="12" fill="#FFFFFF" stroke="#E5E9EF"/>
  <path d="M20 22 a12 12 0 0 1 12 -12 H608 a12 12 0 0 1 12 12 V54 H20 Z" fill="#F7F9FB"/>
  <line x1="20" y1="54" x2="620" y2="54" stroke="#E5E9EF" stroke-width="1"/>
  <text x="44" y="37" font-size="14" font-weight="600" fill="#1F2D3D">📋 發現多個進行中的任務</text>

  <text x="44" y="91" font-size="13.5" fill="#7B8794">1.</text>
  <text x="66" y="91" font-family="'JetBrains Mono',monospace" font-size="12.5" fill="#2563EB">[sf_project]</text>
  <text x="176" y="91" font-size="14" fill="#1F2D3D">專案審核流程</text>
  <rect x="470" y="78" width="86" height="22" rx="11" fill="#FFFBEB" stroke="#FDE68A"/>
  <text x="513" y="93" text-anchor="middle" font-size="11.5" fill="#B45309">testing</text>

  <text x="44" y="127" font-size="13.5" fill="#7B8794">2.</text>
  <text x="66" y="127" font-family="'JetBrains Mono',monospace" font-size="12.5" fill="#2563EB">[core_web]</text>
  <text x="160" y="127" font-size="14" fill="#1F2D3D">登入頁面修復</text>
  <rect x="450" y="114" width="106" height="22" rx="11" fill="#EFF6FF" stroke="#BFDBFE"/>
  <text x="503" y="129" text-anchor="middle" font-size="11.5" fill="#2563EB">requirement</text>
</svg>
</div>
